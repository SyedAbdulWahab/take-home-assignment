...
<b>Once you are ready to submit your code, please either create a repo or a zip file.<br/>Name it: "{your-last-name}-exercise"<b>
 ...
 6. Make sure write unit testing for frontend and backend both.  
 ...
 You have to use React for the frontend. (use jest for frontend unit test)
